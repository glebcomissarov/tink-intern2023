...
Согласно заданию, предполагается, что ритейлер будет ежедневно предоставлять следующие данные
...
Мне кажется, что ритейлеру будет довольно сложно (или невозможно) предоставить первые три вида данных, т.к. связать личные данные попупателя с совершенной покупкой:

- зачастую невозможно (например, у магазина нет специальной карты лояльности или покупатель ее не преобрел / предоставил при оплате)
